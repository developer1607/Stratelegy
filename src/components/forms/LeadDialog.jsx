...
export default function LeadDialog({
  ...
  const { defaults, leadStages, contactSources } = useCrmConfig({
    enabled: open,
  });
  ...
  useEffect(() => {
    ...
    resetValidation,
    defaults.leadStage,
    defaults.contactSource,
    defaults.followUpDate,
  ]);
            ...
            <div className="space-y-4">
              ...
              <div className={formDialogField}>
                ...
                <Input
                  ...
                  onBlur={() =>
                    validation.touchField("next_follow_up", formData)
                  }
                  className={validation.inputClassName("next_follow_up")}
                  aria-invalid={Boolean(
                    validation.fieldError("next_follow_up"),
                  )}
                />
