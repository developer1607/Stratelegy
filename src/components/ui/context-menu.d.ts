...
export const ContextMenuSeparator: React.ForwardRefExoticComponent<
  React.PropsWithChildren<Record<string, unknown>> & React.RefAttributes<HTMLElement>
>;
export const ContextMenuShortcut: React.ForwardRefExoticComponent<
  React.PropsWithChildren<Record<string, unknown>> & React.RefAttributes<HTMLElement>
>;
export const ContextMenuGroup: React.ForwardRefExoticComponent<
  React.PropsWithChildren<Record<string, unknown>> & React.RefAttributes<HTMLElement>
>;
export const ContextMenuPortal: React.ForwardRefExoticComponent<
  React.PropsWithChildren<Record<string, unknown>> & React.RefAttributes<HTMLElement>
>;
export const ContextMenuSub: React.ForwardRefExoticComponent<
  React.PropsWithChildren<Record<string, unknown>> & React.RefAttributes<HTMLElement>
>;
