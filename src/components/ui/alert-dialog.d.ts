...
>;
export const AlertDialogPortal: React.ForwardRefExoticComponent<
  React.PropsWithChildren<Record<string, unknown>> & React.RefAttributes<HTMLElement>
>;
...
export const AlertDialogContent: React.ForwardRefExoticComponent<
  React.PropsWithChildren<Record<string, unknown>> & React.RefAttributes<HTMLElement>
>;
export const AlertDialogHeader: React.ForwardRefExoticComponent<
  React.PropsWithChildren<Record<string, unknown>> & React.RefAttributes<HTMLElement>
>;
export const AlertDialogFooter: React.ForwardRefExoticComponent<
  React.PropsWithChildren<Record<string, unknown>> & React.RefAttributes<HTMLElement>
>;
