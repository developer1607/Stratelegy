...
export const ENTITY_REGISTRY = {
  ...
  Opportunity: {
    ...
    columns: {
      ...
      stage: { type: 'string', writable: true, maxLength: 50, optional: true, default: 'prospecting' },
  ...
  CalendarEvent: {
    ...
    columns: {
      ...
      event_type: { type: 'string', writable: true, maxLength: 50, optional: true, default: 'meeting' },
      ...
      related_to_type: { type: 'string', writable: true, maxLength: 100, optional: true },
      related_to_name: { type: 'string', writable: true, maxLength: 255, optional: true },
      status: { type: 'string', writable: true, maxLength: 50, optional: true, default: 'scheduled' },
      ...crmTimestamps(),
    },
    indexes: [
  ...
  DefaultSettings: {
    ...
    columns: {
      id: { type: 'string', writable: false, maxLength: 36 },
      default_currency: { type: 'string', writable: true, maxLength: 10, optional: true, default: 'AED' },
      default_lead_stage: { type: 'string', writable: true, maxLength: 50, optional: true, default: 'new' },
      default_account_tier: { type: 'string', writable: true, maxLength: 50, optional: true, default: 'B' },
      default_follow_up_days: { type: 'int', writable: true, optional: true, default: 3 },
      default_calendar_view: { type: 'string', writable: true, maxLength: 20, optional: true, default: 'month' },
      first_day_of_week: { type: 'string', writable: true, maxLength: 20, optional: true, default: 'monday' },
      created_date: { type: 'datetime', writable: false },
      updated_date: { type: 'datetime', writable: false },
    },
  },
  ...
  UserPermissions: {
    ...
    indexes: [
      { name: 'idx_user_permissions_user_id', columns: ['user_id'], unique: true },
    ],
  },
