...
export function getPasswordChecks(password = '') {
  ...
  return [
    ...
    { key: 'upper', label: PASSWORD_REQUIREMENT_LABELS[1], met: /[A-Z]/.test(value) },
    { key: 'lower', label: PASSWORD_REQUIREMENT_LABELS[2], met: /[a-z]/.test(value) },
    { key: 'digit', label: PASSWORD_REQUIREMENT_LABELS[3], met: /[0-9]/.test(value) },
    { key: 'special', label: PASSWORD_REQUIREMENT_LABELS[4], met: /[^A-Za-z0-9]/.test(value) },
  ];
}
