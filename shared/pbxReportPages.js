...
export const PBX_OPERATIONAL_REPORT_PAGES = [
  {
    ...
    description:
      "Export fax ATA routing and review offline endpoint delivery status.",
  ...
  },
  {
    ...
    title: "E911",
    description:
      "Hybrid PBX E911 review, emergency pool, and Telco civic addresses.",
...
export const PBX_REPORT_PAGE_ROUTES = PBX_OPERATIONAL_REPORT_PAGES.map(
  (def) => def.page,
);
